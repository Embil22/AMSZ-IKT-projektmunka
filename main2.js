const valuta = {
  ...
  para.value = `${key}`;
  para.innerHTML = `${rJson["data"][key]["code"]}`;
  
  // Append to another element:
  document.getElementById("currency").appendChild(para);
  }}
...
document.body.addEventListener("load", betolt);